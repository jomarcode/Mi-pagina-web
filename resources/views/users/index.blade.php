...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h5 class="m-0">Todos los usuarios</h5>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="box box-primary">
                        <div class="box-header with-border mt-2">
                            {{-- @include('especialidades.partials.modalE') --}}
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center mx-2">
                                                        <div class="mx-2">
                                                            <a href="{{route('users.edit',$user->id)}}" class="btn btn-info btn-xs"><i class="far fa-edit"></i>
                                                            </a>
                                                        ...
                                                        <div>
                                                            <form id="frmDatos" action="{{ route('users.destroy', $user->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
