                ...
                <div class="card-body">
                    <div class="box box-primary">
                        <div class="box-header with-border mt-2">
                            @include('proveedors.partials.modalc')
                        </div>
                                        ...
                                        @foreach ($proveedores as $proveedore)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="rounded-circle" src="{{asset('/img/proveedore/'.$proveedore->image)}}" alt="{{$proveedore->image}}" width="30" height="30">
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center mx-2">
                                                        <div class="mx-2">
                                                            <a href="{{route('proveedors.edit',$proveedore->id)}}" class="btn btn-info btn-xs"><i class="far fa-edit"></i>
                                                            </a>
                                                        ...
                                                        <div>
                                                            <form id="frmDatos" action="{{ route('proveedors.destroy', $proveedore->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
