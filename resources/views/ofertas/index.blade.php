...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h5 class="m-0">Todos las Ofertas</h5>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="box box-primary">
                        <div class="box-header with-border mt-2">
                            @include('ofertas.partials.modalc')
                        </div>
                                        ...
                                        @foreach ($ofertas as $oferta)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="rounded-circle" src="{{asset('/img/ofertas/'.$oferta->image)}}" alt="{{$oferta->image}}" width="30" height="30">
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center mx-2">
                                                        <div class="mx-2">
                                                            <a href="{{route('ofertas.edit',$oferta->id)}}" class="btn btn-info btn-xs"><i class="far fa-edit"></i>
                                                            </a>
                                                        ...
                                                        <div>
                                                            <form id="frmDatos" action="{{ route('ofertas.destroy', $oferta->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
