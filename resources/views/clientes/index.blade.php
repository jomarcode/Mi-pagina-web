...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h5 class="m-0">Todos los Clientes</h5>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="box box-primary">
                        <div class="box-header with-border mt-2">
                            @include('clientes.partials.modalc')
                        </div>
                                        ...
                                        @foreach ($clientes as $cliente)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img class="rounded-circle" src="{{asset('/img/clientes/'.$cliente->image)}}" alt="{{$cliente->image}}" width="30" height="30">
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center mx-2">
                                                        <div class="mx-2">
                                                            <a href="{{route('clientes.edit',$cliente->id)}}" class="btn btn-info btn-xs"><i class="far fa-edit"></i>
                                                            </a>
                                                        ...
                                                        <div>
                                                            <form id="frmDatos" action="{{ route('clientes.destroy', $cliente->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
